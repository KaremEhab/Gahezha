                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        widget.report.reporter.userType ==
                                UserType.customer.name
                            ? customerReportTypesMap[widget.report.reportType]
                                  .toString()
                            : widget.report.reporter.userType ==
                                  UserType.shop.name
                            ? shopReportTypesMap[widget.report.reportType]
                                  .toString()
                            : adminReportTypesMap[widget.report.reportType]
                                  .toString(),
                        style: const TextStyle(
                          fontSize: 16,
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 6),
                      Text(
                        widget.report.reporter.name.toLowerCase().contains(
                              "gahezha",
                            )
                            ? S.current.gahezha_support_team
                      ...
                      const SizedBox(width: 6),
                      Text(
                        widget.report.reporting.name.toLowerCase().contains(
                              "gahezha",
                            )
                            ? S.current.gahezha_support_team
                  ...
                  Padding(
                    ...
                    child: AbsorbPointer(
                      absorbing:
                          widget.report.status == ReportStatusType.pending
                          ? false
                          : true,
