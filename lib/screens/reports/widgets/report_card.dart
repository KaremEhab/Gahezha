            ...
            children: [
                    ...
                    Flexible(
                      child: Row(
                        children: [
                          ...
                          Flexible(
                            child: Text(
                              report.reporter.name.toLowerCase().contains(
                                    "gahezha",
                                  )
              ...
              Row(
                children: [
                  ...
                  Flexible(
                    child: Text(
                      report.reporter.userType == UserType.customer.name
                          ? customerReportTypesMap[report.reportType].toString()
                          : report.reporter.userType == UserType.shop.name
                          ? shopReportTypesMap[report.reportType].toString()
                          : adminReportTypesMap[report.reportType].toString(),
                      overflow: TextOverflow.ellipsis,
