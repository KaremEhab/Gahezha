    ...
    return BlocBuilder<UserCubit, UserState>(
      builder: (context, state) {
        ...
        if (usersList.isEmpty) {
          return Center(child: Text(S.current.no_customers));
        }
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return AccountSettingsCard(
              ...
              referredShopIds: user.referredShopIds,
              commissionBalance: user.commissionBalance,
              paidCommissionBalance: user.paidCommissionBalance,
              remainingCommissionBalance: user.remainingCommissionBalance,
            );
          },
        );
      },
    ...
    return BlocBuilder<ShopCubit, ShopState>(
      builder: (context, state) {
        ...
        if (shopsList.isEmpty) {
          return Center(child: Text(S.current.no_shops));
        }
              ...
              child: BlocConsumer<AdminCubit, AdminState>(
                ...
                builder: (context, state) {
                  return AccountSettingsCard(
                    ...
                    referredByUserId: shop.referredByUserId!,
