    ...
    final List<OrderModel> sampleOrders = [
      OrderModel(
        ...
        items: [
          ...
          OrderItem(name: "Fries", price: "SAR 20"),
        ],
      ),
      OrderModel(
        id: "98",
      ...
      OrderModel(
        ...
        date: DateTime.now(),
        totalPrice: "SAR 90",
        items: [OrderItem(name: "Chicken Ranch Pizza", price: "SAR 90")],
      ),
      OrderModel(
        id: "103",
        ...
        totalPrice: "SAR 75",
        items: [
          OrderItem(name: "Pizza", price: "SAR 75", extras: ["Medium"]),
        ],
      ),
      OrderModel(
        id: "104",
        ...
        totalPrice: "SAR 45",
        items: [OrderItem(name: "Salad", price: "SAR 45")],
      ),
      OrderModel(
        id: "105",
        ...
        totalPrice: "SAR 99",
        items: [OrderItem(name: "Shawarma Wrap", price: "SAR 99")],
      ),
    ];
