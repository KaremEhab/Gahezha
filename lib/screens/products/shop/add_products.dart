...
import 'package:image_picker/image_picker.dart'; // for S.current
    ...
    if (source == ImageSource.gallery) {
      ...
      if (selectedImages.isNotEmpty) {
        for (final img in selectedImages) {
          ...
          if (croppedFile != null) {
            setState(() {
              _images.add(File(croppedFile.path)); // ✅ File
            });
          }
        }
      }
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (_images.isNotEmpty) {
                      ...
                      final snackBar = SnackBar(
                        ...
                        content: Column(
                          ...
                          children: [
                            Text(
                              "${_nameController.text} - Uploading image 1 of ${_images.length}...",
                            ),
                      ...
                      imageUrls = await cloudinaryService.addMultipleImages(
                        _images,
                        folder: "products",
                      );

                      // Close SnackBar after last image
                    ...
                    // Save to Firestore
                    await ProductCubit.instance.createProduct(
                      newProduct,
                      context,
                    );

                    // Show success/failure
                    if (ProductCubit.instance.state
                        is ProductCreatedSuccessfully) {
                    ...
                    } else if (ProductCubit.instance.state is ProductFailure) {
                      final error =
                          (ProductCubit.instance.state as ProductFailure).error;
                      scaffoldMessenger.showSnackBar(
                        SnackBar(
                          content: Text(error),
                          backgroundColor: Colors.red,
